...
namespace Server.MirEnvir
{
    ...
    public class Envir
    {
        ...
        private void FillMagicInfoList()
        {
            ...
            if (!MagicExists(Spell.UnlimitedBladeWorks)) MagicInfoList.Add(new MagicInfo { Name = "UnlimitedBladeWorks", Spell = Spell.UnlimitedBladeWorks, Icon = 106, Level1 = 50, Level2 = 53, Level3 = 56, Need1 = 17000, Need2 = 19000, Need3 = 24000, BaseCost = 80, LevelCost = 15, MPowerBase = 75, MPowerBonus = 35, PowerBase = 30, PowerBonus = 20, Range = 9 });
            if (!MagicExists(Spell.LightningStorm)) MagicInfoList.Add(new MagicInfo { Name = "LightningStorm", Spell = Spell.LightningStorm, Icon = 22, Level1 = 22, Level2 = 25, Level3 = 28, Need1 = 3000, Need2 = 5000, Need3 = 10000, BaseCost = 14, LevelCost = 4, MPowerBase = 8, PowerBase = 8, Range = 9 });
        }
