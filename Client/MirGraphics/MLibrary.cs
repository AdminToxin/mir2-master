...
namespace Client.MirGraphics
{
    public static class Libraries
    {
        ...
        public static readonly MLibrary
            ...
            Magic9 = new MLibrary(Settings.DataPath + "Magic9"),
            Mir3Magic = new MLibrary(Settings.DataPath + "Mir3Magic"),
        ...
        public static readonly MLibrary[] CArmours = new MLibrary[80],
                                          CWeapons = new MLibrary[80],
                                          CWeaponEffect = new MLibrary[67], //weaponeffects
                                          CHair = new MLibrary[9],
                                          CHumEffect = new MLibrary[40],
        ...
        static Libraries()
        {
            ...
            for (int i = 0; i < CWeaponEffect.Length; i++)
                CWeaponEffect[i] = new MLibrary(Settings.CWeaponEffectPath + i.ToString("00")); //weaponeffects
        ...
        private static void LoadGameLibraries()
        {
            ...
            for (int i = 0; i < CWeaponEffect.Length; i++) //weaponeffects
            {
