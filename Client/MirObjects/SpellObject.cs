        ...
        public void Load(S.ObjectSpell info)
        {
            ...
            switch (Spell)
            {
                ...
                case Spell.MeteorStrike:
                    MapControl.Effects.Add(new Effect(Libraries.Mir3Magic, 480, 10, 800, CurrentLocation) { Repeat = true, RepeatUntil = CMain.Time + 3000 });
                    CurrentLocation.Y = Math.Max(0, CurrentLocation.Y - 20);
                    BodyLibrary = Libraries.Mir3Magic;
                    DrawFrame = 530;
                    FrameInterval = 100;
                    FrameCount = 30;
                    Light = 3;
